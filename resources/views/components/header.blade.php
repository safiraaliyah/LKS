...
<body>
  <header class="shadow mb-2 bg-[#08A78B]">
    <div class="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
      ...
      <nav aria-label="Header Navigation" class="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
        <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
          <li class="text-white md:mr-12 hover:text-[#006633]"><a href="/">Home</a></li>
          <li class="relative group text-white md:mr-12 hover:text-[#006633]">
            <button class="dropbtn">Profil</button>
            <div class="dropdown-menu absolute hidden bg-gray-800 text-white rounded-md shadow-lg mt-2">
              <a href="/profile/option1" class="block px-4 py-2 hover:bg-[#006633]">Option 1</a>
              <a href="/profile/option2" class="block px-4 py-2 hover:bg-[#006633]">Option 2</a>
              <a href="/profile/option3" class="block px-4 py-2 hover:bg-[#006633]">Option 3</a>
            </div>
          </li>
          <li class="text-white md:mr-12 hover:text-[#006633]">
